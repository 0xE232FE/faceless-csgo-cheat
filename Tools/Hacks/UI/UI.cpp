...
void KillFeed::Run()
{
	...
	DrawRect(BoxRect.left - 5 - 1, BoxRect.top - 5 - 1, BoxRect.right + 5 + 1, BoxRect.bottom + 5 + 1, CColor(32, 34, 36, 255));
...
void UI::DrawWeapons()
{
	...
	DrawRect( W - Longest - 11, H - Top - 3 - 53, W, H, CColor( 32, 34, 36, 255 ) );
	...
	DrawRect( W - 201, H - 51, W, H, CColor( 32, 34, 36, 255 ) );
	DrawRect( W - 200, H - 66, W, H, CColor( 22.5, 22.5, 22.5, 255 ) );
...
void UI::DrawHealth()
{
	...
	DrawRect( 0, H - 66, 404, H, CColor( 22.5, 22.5, 22.5, 255 ) );
	DrawOutlinedRect( 0, H - 51, 202, H, CColor( 32, 34, 36, 255 ) );
	DrawOutlinedRect( 203, H - 51, 405, H, CColor( 32, 34, 36, 255 ) );

	string Health = to_string( Hacks.LocalPlayer->GetHealth() );
	RECT nameSize = GetTextSize( Hacks.Font_HUD_Big, Health.c_str() );
	Interfaces.pSurface->DrawT( 100 - nameSize.right / 2 - 66, ( H - 33 ) - ( nameSize.bottom / 2.f ), CColor( 255, 255, 255, 255 ), 0xA2, false, "b" );
	...
	Interfaces.pSurface->DrawT( 300 - nameSize.right / 2 - 66, ( H - 33 ) - ( nameSize.bottom / 2.f ), CColor( 255, 255, 255, 255 ), 0xA2, false, Hacks.LocalPlayer->HasHelmet() ? "l" : "a" );
...
void UI::Draw()
{
	...
	bool bDraw = Settings.GetMenuSetting( Tab_Misc, Visuals_Predaction);

...
void ChatBox::Run()
{
	...
	DrawRect( 31, H - 200 - 79, 375, H - 81, CColor( 32, 34, 36, 255 ) );
	DrawRect( 32, H - 200 - 78, 374, H - 82, CColor( 22.5, 22.5, 22.5, 255 ) );

	DrawRect( 35, H - 85 - 22, 371, H - 85, CColor( 5, 5, 5, 255 ) );
	DrawRect( 36, H - 86 - 20, 370, H - 86, ChatEnabled ? CColor( 100, 100, 100, 255 ) : CColor( 32, 34, 36, 255 ) );

	DrawRect( 36, H - 86 - 24, 370, H - 86 - 23, CColor( 32, 34, 36, 255 ) );

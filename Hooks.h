...
public:
	...
	void Hook()
	{
		...
		Font_ic = Interfaces.pSurface->Create_Font();
		...
		Interfaces.pSurface->SetFontGlyphSet( Font_Controls, "Segoe UI Black", 13, 400, 0, 0, FONTFLAG_ANTIALIAS );
		Interfaces.pSurface->SetFontGlyphSet( Font_Tab, "Batman Forever Alternate Cyr", 15, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE );
		Interfaces.pSurface->SetFontGlyphSet( Font_MenuTitle, "Segoe UI Black", 20, 200, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE );
		Interfaces.pSurface->SetFontGlyphSet( Font_Watermark, "Batman Forever Alternate Cyr", 17, 600, 0, 0, FONTFLAG_ANTIALIAS);
		Interfaces.pSurface->SetFontGlyphSet( Font_Logo, "AA American Captain", 48, 600, 0, 0, FONTFLAG_ANTIALIAS );
		Interfaces.pSurface->SetFontGlyphSet( Font_ESP, "Tahoma", 13, 400, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW );
		Interfaces.pSurface->SetFontGlyphSet( Font_HUD, "Snow For Santa cyrillic", 60, 0, 0, 0, FONTFLAG_ANTIALIAS );
		Interfaces.pSurface->SetFontGlyphSet( Font_HUD_Big, "Snow For Santa cyrillic", 120, 0, 0, 0, FONTFLAG_ANTIALIAS);
		Interfaces.pSurface->SetFontGlyphSet( Font_ic, "undefeated", 15, 700, 0, 0, FONTFLAG_ANTIALIAS);
		...
		auto __FONT = CreateFont( 16, 0, 0, 0, 500, 0, 0, 0, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE, "Tahoma" );

		Interfaces.pSurface->SetFontGlyphSet( Font_Icons, "yanderefont by xarex", 24, 500, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE );
		Interfaces.pSurface->SetFontGlyphSet( Font_Weapons, "Tahoma", 18, 500, 0, 0, FONTFLAG_ANTIALIAS );
